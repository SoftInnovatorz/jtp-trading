...
export function TwitterIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M22 5.9c-.68.3-1.4.5-2.16.6a3.76 3.76 0 0 0 1.65-2.07 7.5 7.5 0 0 1-2.38.91A3.74 3.74 0 0 0 12.6 8.5c0 .3.03.58.1.85A10.6 10.6 0 0 1 4.9 4.9a3.74 3.74 0 0 0 1.16 5c-.6-.02-1.17-.19-1.67-.46v.05c0 1.82 1.3 3.35 3.02 3.7-.32.09-.65.13-1 .13-.24 0-.48-.02-.71-.07.48 1.5 1.87 2.6 3.52 2.63A7.5 7.5 0 0 1 2 18.57 10.58 10.58 0 0 0 7.72 20c6.86 0 10.61-5.68 10.61-10.61l-.01-.48A7.6 7.6 0 0 0 22 5.9Z" />
    </svg>
  );
}
...
export function PhoneIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3.5 5.5c0-1.1.9-2 2-2h2l2 4.5-2 1.5a11 11 0 0 0 5 5l1.5-2 4.5 2v2c0 1.1-.9 2-2 2A15.5 15.5 0 0 1 3.5 5.5Z" />
    </svg>
  );
}
